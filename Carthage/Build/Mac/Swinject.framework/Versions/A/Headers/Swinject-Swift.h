...
@interface NSStoryboard (SWIFT_EXTENSION(Swinject))
+ (void)initialize;
@end


@interface NSViewController (SWIFT_EXTENSION(Swinject))
@property (nonatomic, copy) NSString * __nullable swinjectRegistrationName;
@end


@interface NSWindowController (SWIFT_EXTENSION(Swinject))
@property (nonatomic, copy) NSString * __nullable swinjectRegistrationName;
@end
